...
"""
	additional mappings for Volca FM (unofficial firmware 1.09)
...
EV2VOLCAFM109 = [ 	
	...
	PedalToNoteoff(ctrl=CC_Hold) >> [					
		CtrlFilter([CC_Cutoff,CC_Resonance,CC_Attack,CC_Release,CC_Vrate,CC_Vdepth,CC_PortOnoff, CC_PortTime]) %		
			CtrlSplit({	
